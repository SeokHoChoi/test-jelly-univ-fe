...
export default function NyanguInfoPanel() {
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6 md:p-7 lg:sticky lg:top-24">
      ...
      <div className="mb-12">
        ...
        <div className="mb-8">
          ...
          <div className="mt-6 text-center">
            <h3 className="text-[24px] md:text-[28px] font-bold text-gray-900 mb-2">냥구</h3>
            <p className="text-[16px] md:text-[17px] text-gray-600">셔틀랜드 쉽독</p>
          </div>
        </div>

        {/* 기본 정보 - 기본 노출 */}
        <div className="mb-6">
          <h4 className="text-[15px] md:text-[16px] font-semibold text-gray-900 mb-3">기본 정보</h4>
          <p className="text-[14px] md:text-[15px] text-gray-700">
            냥구 / 셔틀랜드 쉽독 / 2024년 1월 17일 생
          </p>
        </div>

        {/* 신체 정보 - 기본 노출 */}
        <div className="mb-6">
          <h4 className="text-[15px] md:text-[16px] font-semibold text-gray-900 mb-3">신체 정보</h4>
          <p className="text-[14px] md:text-[15px] text-gray-700">
            12kg / 남아 / 중성화 완료
          </p>
        </div>
        ...
        <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
          ...
          <div className="flex items-center gap-3 mt-6 pt-4 border-t border-gray-200">
            ...
            <div>
              <p className="text-[14px] md:text-[15px] font-semibold text-gray-900">냥구 보호자 박해주</p>
              <p className="text-[12px] md:text-[13px] text-gray-500">젤리대학교 Founder</p>
            </div>
          </div>
        </div>
      </div>

      {/* 공여건 선정 소개 - 성과 카드 (기본 노출) */}
      <div className="mb-12">
        <div className="mb-6">
          <h3 className="text-[22px] md:text-[26px] font-bold text-gray-900 mb-4 leading-tight">
            상위 1%<br />
            장 건강으로 인증받은<br />
            냥구의 식단 설계 비밀
          </h3>
          <div className="inline-block bg-[#003DA5] text-white px-6 py-3 rounded-lg mb-6">
            <p className="text-[18px] md:text-[20px] font-bold">🏆 407마리 중 4마리</p>
          </div>
        </div>
        <div className="space-y-4 text-[15px] md:text-[16px] text-gray-700 leading-relaxed">
          <p>
      ...
      {/* 수의학계에서 이상적인 장 환경으로 인정 받은 수치 - 스토리 하이라이트 (기본 노출) */}
      <div>
        <h3 className="text-[20px] md:text-[24px] font-bold text-gray-900 mb-8 leading-tight">
          수의학계에서 이상적인 장 환경으로 인정 받은 수치
        </h3>

        {/* 핵심 수치만 기본 노출 */}
        <div className="mb-2">
          <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
            <h4 className="text-[16px] md:text-[17px] font-semibold text-gray-900 mb-4">장내 미생물 균형도</h4>
            <div className="bg-[#F4F8FF] border border-[#D6E4FF] rounded-lg p-5">
              <p className="text-[14px] text-gray-600 mb-2">냥구 불균형 지수</p>
              <p className="text-[36px] font-extrabold text-[#003DA5] mb-1">-5.58</p>
              <p className="text-[13px] text-gray-500">(458% 더 좋은 수치)</p>
              <p className="text-[12px] text-gray-400 mt-3">*균형 등급 기준 -1 미만</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* 냥구는 이렇게 먹어요 - 급여 요약 (기본 노출) */}
      <div>
        <h3 className="text-[20px] md:text-[24px] font-bold text-gray-900 mb-8">😋 냥구는 이렇게 먹어요</h3>

        {/* 급여 요약 카드 */}
        <div className="bg-gray-50 rounded-lg p-6 border border-gray-200 mb-2">
          <div className="grid grid-cols-2 gap-4 mb-4">
            <div>
              <p className="text-[13px] text-gray-600 mb-1">하루 급여량</p>
              <p className="text-[18px] font-bold text-gray-900">120g</p>
            </div>
            <div>
              <p className="text-[13px] text-gray-600 mb-1">하루 목표 칼로리</p>
              <p className="text-[18px] font-bold text-gray-900">451~632kcal</p>
            </div>
          </div>
          <div className="pt-4 border-t border-gray-200">
            <p className="text-[14px] text-gray-700 leading-relaxed">
              아침과 저녁에 주식과 보조식을 함께 급여하고, 산책과 노즈워크 시 간식으로 나머지를 제공합니다.
            </p>
          </div>
        </div>
      </div>
