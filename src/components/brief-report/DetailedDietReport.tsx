    ...
    <div className="bg-[#F2F2F2] min-h-screen py-6 px-4 md:py-[58px] md:px-[64px]">
      <div className="max-w-[1280px] mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 md:gap-x-[80px] mb-8">
          ...
          <div className="bg-[#003DA5] rounded-[20px] pt-[46px] pb-[36px] px-[18px] text-white relative md:order-1">
            ...
            <div className="text-center">
              ...
              <p className="text-[22px] font-medium text-white leading-relaxed px-[4px]">
          ...
          {/* 냥구는요 카드 */}
          <div className="bg-gray-200 rounded-[20px] p-6 md:order-2">
            <div className="flex items-start gap-4">
              <span className="text-2xl">🐾</span>
              <div>
                <h2 className="text-xl font-bold mb-2 text-[#1E1E1E]">냥구는요</h2>
                <p className="text-sm leading-relaxed text-[#525252]">
                  넘치는 에너지와 좋은 골격을 가졌지만, 현재는 몸이 조금 무거운 유망주.<br />
                  전문적인 관리를 통해 최고의 컨디션을 되찾을 준비가 되어 있으며,<br />
                  체중 감량과 동시에 근육량 유지가 가능한 타입입니다.
                </p>
              </div>
            </div>
          </div>
          ...
          {/* 체중 및 신체충실도 진단 */}
          <div className="bg-white rounded-[20px] p-6 md:order-5 md:mt-[24px]">
            <div className="flex items-start gap-3 mb-4">
              <Scale className="w-5 h-5 text-[#003DA5] mt-1" />
          ...
          {/* 생애주기 평가 */}
          <div className="bg-white rounded-[20px] p-6 md:order-6 md:mt-[35px]">
            <div className="flex items-start gap-3 mb-4">
              <Calendar className="w-5 h-5 text-[#003DA5] mt-1" />
              <h3 className="text-lg font-semibold text-[#1E1E1E]">
                생애주기 평가
              </h3>
            </div>
          ...
          {/* 셔틀랜드 쉽독 카드 */}
          <div className="bg-white rounded-[20px] p-6 md:order-3 md:mt-[24px]">
        ...
        <div className="bg-white rounded-[20px] p-6">
          <div className="flex items-start gap-3 mb-4">
            <Target className="w-5 h-5 text-[#003DA5] mt-1" />
            <h3 className="text-lg font-semibold text-[#1E1E1E]">
              {petInfo.name}의 목표 체중과 하루 권장 칼로리
            </h3>
          </div>
          <p className="text-xs text-[#8B8B8B] mb-4">
            현재 신체 상태를 과학적으로 분석하여, 수의영양학 기준 목표 체중과 하루 목표 섭취 칼로리를 제시해드려요!
          </p>
        ...
        <div className="bg-white rounded-[20px] p-6">
          <div className="flex items-start gap-3 mb-4">
            <BarChart3 className="w-5 h-5 text-[#003DA5] mt-1" />
            <h3 className="text-lg font-semibold text-[#1E1E1E]">
              현재 식단의 주요 영양소 함량 분석
            </h3>
          </div>
          <p className="text-xs text-[#8B8B8B] mb-4">제품 라벨에서는 알려주지 않는 각 제품의 섭취량과 칼로리에 따른 단백질, 지방 그리고 탄수화물의 함량을 자세히 파악해요! (AS FED 기준)</p>
        ...
        <div className="bg-[#003DA5] rounded-[20px] p-6 text-white">
          <h3 className="text-lg font-semibold mb-2">주요 영양소의 1일 권장 섭취량</h3>
          <p className="text-xs text-blue-100 mb-4">1일 권장 칼로리(DER) 기준 단백질, 지방, 탄수화물의 섭취량과 음수량을 제시해드려요!</p>
        ...
        <div className="bg-white rounded-[20px] p-6">
          ...
          <p className="text-xs text-[#8B8B8B] mb-6">
            위에서 분석한 현재와 권장 칼로리 및 주요 영양소를 비교 분석해 현재 식단이 어떤 상태인지 더 자세히 파악해요!
          </p>
        ...
        <div className="bg-white rounded-[20px] overflow-hidden">
          ...
          <div className="bg-[#003DA5] p-6">
            <div className="flex items-start gap-3">
              <Handshake className="w-5 h-5 text-white mt-1" />
              <h3 className="text-lg font-semibold text-white">
                주식과 영양제의 상호작용 평가
              </h3>
            </div>
            <p className="text-xs text-blue-100 mt-2">
              주식과 영양제가 서로 보완관계에 있는지 또는 과유불급은 아닐지 등을 평가해요!
            </p>
          </div>
        ...
        <div className="bg-white rounded-[20px] p-6">
          <div className="flex items-start gap-3 mb-4">
            <Clipboard className="w-5 h-5 text-[#003DA5] mt-1" />
            <h3 className="text-lg font-semibold text-[#1E1E1E]">
              종합 결론 및 솔루션
            </h3>
          </div>
          <p className="text-xs text-[#8B8B8B] mb-6">
            현재 급여 식단에 대한 종합적인 진단과 그에 따른 실행 계획을 알려드려요!
          </p>
